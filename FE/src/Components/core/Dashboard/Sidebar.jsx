    ...
    <div className=' text-white bg-richblack-800'>
        ...
        h-[calc[100vh-3.5rem)] bg-richblack-800 py-10'>
            ...
            <div className='flex flex-col'>
                {
                    // id already bani hue h in dashboard-links that is why no need to 
                    // send index in map function
        ...
        <div className='flex flex-row items-baseline gap-1 w-full justify-between'>
                {
                    sidebarLinks.map((link) => {
                        if(link.type && user?.accountType !== link.type) return null;
                        return (
